...
from app.api import blogposts, notes, ping, users_htmlpages, video, htmlpages, upload, backups, articles
...
def create_application() -> FastAPI:
    ...
    # install the articles router into our app with a prefix & tag too:
